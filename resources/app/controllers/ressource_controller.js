...
exports.create = function (req, res){
   ...
   var ressource = new Ressource();
    ...
    ressource.set('deaktiviertAm',      req.body.deaktiviertAm);
    ressource.set('land',               req.body.land);
    ressource.set('verwendungszweck',   req.body.verwendungszweck);
    ressource.set('inventarNr',         req.body.inventarNr);
    ressource.set('mobiledevmgmt',      req.body.mobiledevmgmt);
    ...
    Ressource.findOne({_id: req.body._id}).exec(function(err, ressource) {
        if (err) {
            ...
            if (req.body.mobiledevmgmt === undefined | req.body.mobiledevmgmt === null ){
                ressource.mobiledevmgmt = false;
            } else {
                ressource.mobiledevmgmt = true;
            }
            if (req.body.verwendungszweck !== undefined & req.body.verwendungszweck !== null) {
                ressource.verwendungszweck = req.body.verwendungszweck;
            }
            if (req.body.inventarNr !== undefined & req.body.inventarNr !== null) {
                ressource.inventarNr = req.body.inventarNr;
            }
            if (req.body.land !== undefined & req.body.land !== null) {
                ressource.land = req.body.land;
            }
            if (req.body.deaktiviertAm !== undefined & req.body.deaktiviertAm !== null) {
                ressource.deaktiviertAm = req.body.deaktiviertAm;
            }
