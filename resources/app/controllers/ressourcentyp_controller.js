...
exports.create = function (req, res){
   var ressourcentyp = new RessourcenTyp();
    ...
    ressourcentyp.set('physisch', req.body.physisch);
...
exports.save = function (req, res){
    RessourcenTyp.findOne({_id: req.body._id}).exec(function(err, ressourcentyp) {
        if (err) {
            ...
            if (req.body.physisch === undefined | req.body.physisch === null ){
                ressourcentyp.physisch = false;
            } else {
                ressourcentyp.physisch = true;
            }
